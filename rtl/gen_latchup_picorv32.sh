...
fusesoc library add picorv32 https://github.com/JoGei/picorv32
export PICORV32="$WORKSPACE/fusesoc_libraries/picorv32"
fusesoc core list | grep -i picorv32
